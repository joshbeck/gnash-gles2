...
class  DSOEXPORT Renderer_gles2: public Renderer
{
public:
    std::string description() const { return "OpenGLES2"; }

    Renderer_gles2();
    Renderer_gles2(renderer::GnashDevice::dtype_t dtype);
...
//    void setFillPaint(const VGPaint paint) { _fillpaint = paint; }
    ...
    void printGLES2Params();
    void printGLES2Hardware();
//    static void printGLES2Path(GLPath path);
    static void printGLES2Matrix(GLfloat *mat);
    static void printGLES2Matrix(const SWFMatrix &mat);
